...
### (More grammar rules to be defined)
- Cases (subject/object/possession): TBD
- Word order: TBD
...
- j → dropped (too similar to i)
- jen → changed to 'kin' (after dropping j)
- jun → changed to 'nu' (after dropping j)

### Similar structures to monitor:
- CVC verbs: hav, mak, vis, her, lok, pat (acceptable - different consonants)
- Words ending in -ol: sol (only 1 now that kol became color)
...
- CV structure: ~24 roots (30%)
- CVC structure: ~57 roots (70%)
- Average root length: ~3.0 letters

## Next Steps
- [ ] Define grammatical affixes (plural, tense, cases, etc.)
- [ ] Expand vocabulary to ~100 roots
- [ ] Test sentence construction
- [ ] Check for phonetic balance (are we using all consonants efficiently?)
- [ ] Create example sentences
- [ ] Design writing system (use Latin alphabet or create new?)
